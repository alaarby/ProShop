...
const OrderInfo = () => {
  ...
  return(
    <div className="w-[289px] h-[154px] flex flex-col items-start">
      ...
      <div>
        <h4 className="text-[22px] text-[#242424] mt-[16px]">{payment.nameOnCard}</h4>
        <p className="text-[16px] text-[#000000] mt-[9px]">{shipping.street}, {shipping.city}, {shipping.country} - {shipping.zipCode}</p>
      </div>
    </div>
  )
}           
