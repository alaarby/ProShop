  ...
  return(
    <div className="w-[537px] flex flex-col items-end mt-[30px] ml-[36px]">
      <div className="w-full rounded-[16px] bg-[#F2F2F2] flex flex-col  justify-center  py-[35px] px-[22px] relative">
        <h3 className="text-[32px] text-[#242424] text-starts font-bold">Order Details</h3>
        <span className="text-[22px] text-[#707070] absolute top-[42px] right-[29px] underline">Change</span>
