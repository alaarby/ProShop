...
const TotalCartValue = () => {
  ...
  return (
    <div className="flex flex-col items-start justify-center w-full max-w-[384px] h-[351px] bg-[#F2F2F2] p-4 rounded-[16px]">
      <h3 className="text-[32px] text-[#242424] font-semibold">
        Subtotal ({cart?.totalQuantity}) items
      </h3>
      <p className="text-[24px] text-[#707070] font-semibold line-through mt-[30px]">
        ${cart?.totalPrice.toFixed(2)}
      </p>
      <h3 className="text-[38px] text-[#242424] font-bold mt-[9px]">
